...
export type StorageHash =
  StorageHashBase<'c84e756f34f572a8c4416b4e090ab3421ecf633c84bb6264c3e0da7b06ce7b9c'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly AgentRun: {
      ...
      readonly reservedCredits: CodecTypes['pg/int4@1']['output'];
      readonly settledCredits: CodecTypes['pg/int4@1']['output'];
    ...
    readonly ToolInvocation: {
      ...
      readonly subModelId: CodecTypes['pg/text@1']['output'] | null;
      ...
      readonly estimatedMicrocredits: CodecTypes['pg/int4@1']['output'] | null;
      readonly actualMicrocredits: CodecTypes['pg/int4@1']['output'] | null;
      readonly waitpointToken: CodecTypes['pg/text@1']['output'] | null;
      readonly errorCode: CodecTypes['pg/text@1']['output'] | null;
      readonly errorMessage: CodecTypes['pg/text@1']['output'] | null;
      readonly idempotencyKey: CodecTypes['pg/text@1']['output'] | null;
      readonly startedAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    readonly AgentRun: {
      ...
      readonly reservedCredits: CodecTypes['pg/int4@1']['input'];
      readonly settledCredits: CodecTypes['pg/int4@1']['input'];
    ...
    readonly ToolInvocation: {
      ...
      readonly subModelId: CodecTypes['pg/text@1']['input'] | null;
      ...
      readonly estimatedMicrocredits: CodecTypes['pg/int4@1']['input'] | null;
      readonly actualMicrocredits: CodecTypes['pg/int4@1']['input'] | null;
      readonly waitpointToken: CodecTypes['pg/text@1']['input'] | null;
      readonly errorCode: CodecTypes['pg/text@1']['input'] | null;
      readonly errorMessage: CodecTypes['pg/text@1']['input'] | null;
      readonly idempotencyKey: CodecTypes['pg/text@1']['input'] | null;
      readonly startedAt: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
          ...
          readonly table: {
            ...
            readonly toolInvocation: {
              columns: {
                ...
                readonly estimatedMicrocredits: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: true;
                };
                readonly actualMicrocredits: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: true;
                };
                readonly waitpointToken: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
              ...
              indexes: readonly [
                {
                  readonly name: 'toolInvocation_providerRunId_idx_c8aef772';
                  readonly prefix: 'toolInvocation_providerRunId_idx';
                  readonly columns: readonly ['providerRunId'];
                  readonly unique: false;
                },
                {
          ...
          readonly AgentRun: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly reservedCredits: { readonly column: 'reservedCredits' };
                readonly settledCredits: { readonly column: 'settledCredits' };
          ...
          readonly ToolInvocation: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly subModelId: { readonly column: 'subModelId' };
                ...
                readonly estimatedMicrocredits: { readonly column: 'estimatedMicrocredits' };
                readonly actualMicrocredits: { readonly column: 'actualMicrocredits' };
                readonly waitpointToken: { readonly column: 'waitpointToken' };
                readonly errorCode: { readonly column: 'errorCode' };
                readonly errorMessage: { readonly column: 'errorMessage' };
                readonly idempotencyKey: { readonly column: 'idempotencyKey' };
                readonly startedAt: { readonly column: 'startedAt' };
